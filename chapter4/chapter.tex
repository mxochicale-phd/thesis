...
The aims of the experiments is not only tackling the weaknesses and 
robustness of RSS, UTDE, embedding parameters, RP and RQA metrics regarding 
different conditions for time-series (smoothness, windowsizes and structures), 
but also considering the models of \cite{stergiou2006} and 
\cite{vaillancourt2002, vaillancourt2003} for human movement variability.
...
for the experiment of Human-Image Imitation (HII) activities due to various 
problems with the inertial sensors such as bluetooth disconnections and
time synchronisation drifting (Section \ref{appendix:imus:issues}).
