...
%****************************** Appendix F *************************************
%*******************************************************************************
\chapter{Additional results for HHI experiment} \label{appendix:f}
...
\includegraphics[width=1.0\textwidth]{ts_H_sg0}
	...
	\codelink{
	https://github.com/mxochicale-phd/thesis/tree/master/0_code_data/1_code/9_figs_appendixes/appendix_hri/ts/code
	}.
        }
    \label{fig:aH-sg0}
\end{figure}
...
\includegraphics[width=1.0\textwidth]{cao_aHw10}
	...
	\R code to reproduce the figure is available at 
	\codelink{
	https://github.com/mxochicale-phd/thesis/tree/master/0_code_data/1_code/9_figs_appendixes/appendix_hri
	}.
        }
    \label{fig:caoH}
\end{figure}
...
\newpage
\section{RPs} \label{appendix:f:rps}
...
we refer the reader to download the data and code at \cite{xochicale2019}.
...
\newpage
\section{RQAs} \label{appendix:f:rqas}
