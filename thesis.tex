...
\include{appendixB/appendix} % Inertial Sensors
\include{appendixC/appendix} % Experiment Design
\include{appendixD/appendix} % Results for HII
\include{appendixE/appendix} % Results for HHI
\include{appendixF/appendix} % Open Access Code and Data
\end{appendices}
