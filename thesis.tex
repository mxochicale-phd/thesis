...
\include{appendixA/appendix} % Open Access Code and Data
\include{appendixB/appendix} % Examples of Uniform TDE
\include{appendixC/appendix} % Equipment
\include{appendixD/appendix} % Experiment Design
\include{appendixE/appendix} % Results for HII
\include{appendixF/appendix} % Results for HHI
\end{appendices}
