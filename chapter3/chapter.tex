...
\begin{figure}
  \centering
    \includegraphics[width=1.0\textwidth]{fig_3_01}
	...
	and R code to reproduce the figure is available from \cite{xochicale2018}.
    }
    \label{fig:ssr}
\end{figure}
%%---------------------------------(FIGURE)-------------------------------------
...
\begin{figure}[!h]
  \centering
	...
	reproduce it is available from \cite{xochicale2018}.
	}
    \label{fig:mrp}
\end{figure}
%%---------------------------------(FIGURE)-------------------------------------
