...
plots_path <- paste( outcomes_plot_path, '/', selectParticipant, '/', activitytag, '/', sensors, sep='')
...
persp3D(
	...
	#contour = list(col = "grey", side = c("z")) # countour of layers 
)
