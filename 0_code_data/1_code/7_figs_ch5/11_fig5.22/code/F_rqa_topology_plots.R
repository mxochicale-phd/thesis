...
filenameimage <- paste(selectWindow, '_', rqask, '_', sensork, '_', activityk, '_', axisk, '_', activitytag, '.png', sep='')
...
persp3D(
	...
	cex.axis = # change axis tick size to a very low size
