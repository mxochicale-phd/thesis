...
%****************************** Appendix E *************************************
%*******************************************************************************
\chapter{Additional Results for HII experiment} \label{appendix:e}
...
\includegraphics[width=0.8\textwidth]{ts_H_sg0}
	...
	\codelink{
	https://github.com/mxochicale-phd/thesis/tree/master/0_code_data/1_code/9_figs_appendixes/appendix_hii/ts/code
	}.
        }
...
\includegraphics[width=1.0\textwidth]{cao_Hnb_w10}
	...
	(no beat).} 
		...
		\R code to reproduce the figure is available at 
		\codelink{
		https://github.com/mxochicale-phd/thesis/tree/master/0_code_data/1_code/9_figs_appendixes/appendix_hii/
		}.
        }
    \label{fig:a:caoHnb}
\end{figure}
